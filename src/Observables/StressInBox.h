...
protected:
    ...
    // Helpers
    LR_vector _pbc_displacement_to_center(const LR_vector& r) const;
    bool _inside_box(const LR_vector& r) const;
...
public:
    ...
    // We will need particle positions/forces accessible on CPU
